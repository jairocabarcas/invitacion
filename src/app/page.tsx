...
import {BORDER_COLOR} from "@/app/utils/constants";

export default function Home() {
  return (
      <div className="min-h-screen flex items-center justify-center md:px-4 md:py-10 p-2">
        <div className="max-w-xl w-full bg-fondo bg-repeat bg-cover shadow-2xl p-3 md:p-10">
          <div className={`w-full border-5 border-[${BORDER_COLOR}] px-3 py-5 md:p-5`}>
              <HeaderLogo />
              <InvitationText />
              <DateInfo />
              <Location />
